...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = BaseApplication.getContexe().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = BaseApplication.getContexe().getResources().getDisplayMetrics().scaledDensity;
